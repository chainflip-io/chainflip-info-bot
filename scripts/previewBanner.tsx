...
const [
  ...
  fileToDataUrl(join(root, 'src/assets/backgrounds/tier1-boosted.png')),
  fileToDataUrl(join(root, 'src/assets/backgrounds/tier2-regular.png')),
  fileToDataUrl(join(root, 'src/assets/backgrounds/tier2-boosted.png')),
  fileToDataUrl(join(root, 'src/assets/backgrounds/tier3-regular.png')),
  fileToDataUrl(join(root, 'src/assets/backgrounds/tier3-boosted.png')),
  ...
  fileToDataUrl(join(root, 'src/assets/tokens/trx-small.png')),
  fileToDataUrl(join(root, 'src/assets/tokens/trx.png')),
  fileToDataUrl(join(root, 'src/assets/tokens/btc.png')),
  fileToDataUrl(join(root, 'src/assets/tokens/eth.png')),
  fileToDataUrl(join(root, 'src/assets/swap-icon.png')),
  fileToDataUrl(join(root, 'src/assets/chains/eth.png')),
  fileToDataUrl(join(root, 'src/assets/chains/arb.png')),
  fileToDataUrl(join(root, 'src/assets/chains/tron.png')),
...
const tier23Variants: { name: string; props: SwapBannerProps }[] = [
  ...
  },
  {
    ...
    props: {
      usdValue: 1_284_450,
      sourceAsset: { iconUrl: bnbSmall, symbol: 'BNB', amount: 1850 },
      destAsset: { iconUrl: usdtSmall, symbol: 'USDT', amount: 1_284_450, chainBadgeUrl: ethChain },
  ...
  },
  {
    ...
    props: {
      usdValue: 720_000,
      sourceAsset: { iconUrl: cbbtcSmall, symbol: 'cbBTC', amount: 7.05 },
      destAsset: { iconUrl: usdtSmall, symbol: 'USDT', amount: 720_000, chainBadgeUrl: ethChain },
      aggregator: 'swap.chainflip.io',
      oraclePriceDeltaPct: -0.04,
      isBoosted: false,
      durationMinutes: 7,
  ...
  },
  {
    ...
    props: {
      usdValue: 600_000,
      sourceAsset: { iconUrl: usdtSmall, symbol: 'USDT', amount: 600_000, chainBadgeUrl: bscChain },
      destAsset: { iconUrl: btcSmall, symbol: 'BTC', amount: 9.6 },
      aggregator: 'swap.chainflip.io',
      oraclePriceDeltaPct: -0.04,
      isBoosted: false,
      durationMinutes: 7,
