...
const [
  ...
  fileToDataUrl(join(root, 'src/assets/backgrounds/Largest swap_Regular.png')),
  fileToDataUrl(join(root, 'src/assets/backgrounds/Largest swap_Boosted.png')),
...
const tier23Variants: { name: string; props: SwapBannerProps }[] = [
  ...
  },
  {
    ...
    props: {
      usdValue: 2_400_000,
      sourceAsset: { iconUrl: cbbtcSmall, symbol: 'cbBTC', amount: 23.3 },
      destAsset: { iconUrl: usdtSmall, symbol: 'USDT', amount: 2_400_000, chainBadgeUrl: ethChain },
      aggregator: 'swap.chainflip.io',
      oraclePriceDeltaPct: -0.05,
      isBoosted: false,
      durationMinutes: 11,
